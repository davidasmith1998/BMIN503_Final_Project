---
title: "Diabetes Prediction and Risk Factors"
...
The project aims to utilize the 2015 Behavioral Risk Factor Surveillance System (BRFSS) dataset to predict diabetes risk among individuals based on their responses to health-related survey questions. By analyzing these responses, the project seeks to determine the accuracy of using survey data to predict diabetes status and identify the most significant risk factors associated with the disease.
